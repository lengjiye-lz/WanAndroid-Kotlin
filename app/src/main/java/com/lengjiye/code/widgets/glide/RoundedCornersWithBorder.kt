 ...
 * 带边框的圆角图片
 */
class RoundedCornersWithBorder(private val strokeWidth: Int?, private val strokeColor: Int?, private val roundingRadius: Int?) : BitmapTransformation() {
    ...
    private fun circleWithBorder(pool: BitmapPool, inBitmap: Bitmap, destWidth: Int, destHeight: Int): Bitmap {
        ...
        val bitmap = TransformationUtils.roundedCorners(pool, inBitmap, roundingRadius ?: 1)
    ...
    override fun equals(other: Any?): Boolean {
        return other is RoundedCornersWithBorder
    }
