...
public class GamItemTouchCallback extends ItemTouchHelper.Callback {
    ...
    public GamItemTouchCallback(int defaultScrollX) {
    ...
    public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        ...
        if (isCurrentlyActive) { // 手指滑动
            ...
            if (viewHolder.itemView.getScrollX() >= mDefaultScrollX) {
                ...
                LogTool.de("dX:" + dX + " mInitXWhenInactive:" + mInitXWhenInactive);
                LogTool.de("dX:" + dX + " mCurrentScrollXWhenInactive * dX / mInitXWhenInactive:" + mCurrentScrollXWhenInactive * dX / mInitXWhenInactive);
